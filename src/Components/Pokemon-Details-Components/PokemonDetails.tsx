...
function PokemonDetails() {
  ...
  return (
    <div className="min-h-[80vh] ">
      <Link
        to={"/pokedex/" + site}
        className="w-fit flex gap-2 justify-center items-center px-3 py-2 text-sm font-medium text-center  dark:text-blue-100 dark:bg-slate-700 rounded-r bg-blue-50  text-blue-700"
      >
        <svg
      ...
      <div className=" flex flex-col items-center md:flex-row gap-20 justify-between md:mt-24 max-w-5xl mx-auto px-1">
        {/* PICTURE */}
        {loading && (
        ...
        <div className="max-w-lg w-full px-4 ">
          <div className="px-4 sm:px-0">
            <div className="flex gap-2 items-center">
              ...
              <span className="bg-gray-100 text-gray-800 text-sm font-medium mr-2 px-2.5 py-0.5 h-fit rounded dark:bg-gray-700 dark:text-gray-300">
                #{pokemon?.id}
              </span>
            </div>
            {/* TYP */}
            <div className="flex flex-wrap gap-2 mt-4">
              {/* {!loading &&
                pokemon.types.map((typo: any) => {
                  console.log(typo.type.name);
                  <TypBadges text={typo.type.name} type={typo.type.name} />;
                })} */}
